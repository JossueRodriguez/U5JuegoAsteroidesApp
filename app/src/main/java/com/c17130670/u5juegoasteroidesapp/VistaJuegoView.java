...
:*  Descripción : Este Activity es donde se pone los valores del juego el inicio
                  y la logica del juego
:*  Ultima modif:
...
public class VistaJuegoView extends View {
    ...
    protected void onSizeChanged ( int w, int h, int oldw, int oldh ) {
        ...
        Toast.makeText ( getContext(), "Francisco Jossue Rodriguez Gallegos (17130670)", Toast.LENGTH_SHORT ).show ();
    ...
    private void activaMisil () {
        ...
        // Reproducir el audio del mplayAudioDisparo
    ...
    public void setplayAudioDisparo(MediaPlayer mplayAudioDisparo) {
